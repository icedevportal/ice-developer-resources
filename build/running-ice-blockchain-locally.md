...
Now you will be able to make RPC calls to the local ICE node, [deploy Solidity smart contracts](evm-and-solidity/using-hardhat/), [interact with the smart contracts](evm-and-solidity/using-hardhat/interact-with-contracts-using-hardhat.md).
